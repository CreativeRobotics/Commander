...
bool Commander::checkCommand(uint16_t cmdIdx){
	...
	if(bufferString.length() < commandLengths[cmdIdx]+1U) return false; //no match if the buffer is shorter than the command+1 (buffer will have the end of line char)
